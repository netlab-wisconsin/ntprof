 ...
 */
void udpate_raw_blk_stat(struct blk_io_instance *bio, struct atomic_blk_stat *raw_blk_stat) {
  unsigned int size;
...
int init_blk_layer_proc_entries(void) {
  ...
  entry_blk_stat = proc_create(stat_name, 0, entry_blk_dir, &nttm_blk_stat_fops);
  if (!entry_blk_stat) {
